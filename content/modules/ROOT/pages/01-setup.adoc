...
In this lab, you will learn about https://rpm.org/[RPM], the native
package format used by Fedora, CentOS, and RHEL.  RPM is a powerful and
flexible tool that plays a vital role in the management and distribution
of software for these operating systems. 
