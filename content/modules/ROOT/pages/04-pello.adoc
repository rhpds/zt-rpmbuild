...
----
### OUTPUT ABRIDGED ###
Wrote: /root/rpmbuild/SRPMS/pello-1.0.4-1.el9.src.rpm
Wrote: /root/rpmbuild/RPMS/noarch/pello-1.0.4-1.el9.noarch.rpm
Executing(%clean): /bin/sh -e /var/tmp/rpm-tmp.npnz0l
+ umask 022
+ cd /root/rpmbuild/BUILD
+ cd Pello-1.0.4
+ /usr/bin/rm -rf /root/rpmbuild/BUILDROOT/pello-1.0.4-1.el9.x86_64
+ RPM_EC=0
++ jobs -p
+ exit 0
----
