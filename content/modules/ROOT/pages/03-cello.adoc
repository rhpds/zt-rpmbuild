...
----
### OUTPUT ABRIDGED ###
Wrote: /root/rpmbuild/SRPMS/cello-1.0-1.el9.src.rpm
Wrote: /root/rpmbuild/RPMS/x86_64/cello-debuginfo-1.0-1.el9.x86_64.rpm
Wrote: /root/rpmbuild/RPMS/x86_64/cello-1.0-1.el9.x86_64.rpm
Wrote: /root/rpmbuild/RPMS/x86_64/cello-debugsource-1.0-1.el9.x86_64.rpm
Executing(%clean): /bin/sh -e /var/tmp/rpm-tmp.HECHUO
+ umask 022
+ cd /root/rpmbuild/BUILD
+ cd cello-1.0
+ /usr/bin/rm -rf /root/rpmbuild/BUILDROOT/cello-1.0-1.el9.x86_64
+ RPM_EC=0
++ jobs -p
+ exit 0
----
