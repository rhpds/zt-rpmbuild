...
matches our source code archive filename. Note that the *Source* tag
below uses the *%\{url}* macro, which will expand to the value you set
in the *URL* tag. Define *BuildArch* as *noarch* to mark the package as
