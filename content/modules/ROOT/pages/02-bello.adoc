...
[source,bash]
----
mv -v /root/downloads/bello-0.1.tar.gz SOURCES/
----

[source,nocopy]
----
renamed '/root/downloads/bello-0.1.tar.gz' -> 'SOURCES/bello-0.1.tar.gz'
----
...
[source,nocopy]
----
Wrote: /root/rpmbuild/SRPMS/bello-0.1-1.el10.src.rpm
Wrote: /root/rpmbuild/RPMS/noarch/bello-0.1-1.el10.noarch.rpm
Executing(%clean): /bin/sh -e /var/tmp/rpm-tmp.ljskTE
+ umask 022
+ cd /root/rpmbuild/BUILD
+ cd bello-0.1
+ /usr/bin/rm -rf /root/rpmbuild/BUILDROOT/bello-0.1-1.el10.x86_64
+ RPM_EC=0
++ jobs -p
+ exit 0
----
